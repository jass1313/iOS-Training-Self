...
print(numberofplanet)

for planet in Planet.allCases {
    print(planet)
}

var directionToHead1 = Planet.earth
...
var checkTheValue = Planet1.mercury.rawValue
print(checkTheValue)
...
var checktheValue = Planet2.mercury.rawValue
...
checktheValue = CompassPoint1.north.rawValue
let sunsetDirection = CompassPoint1.west.rawValue
// sunsetDirection is "west"


//Initializing from a Raw Value
let possiblePlanet = Planet1(rawValue: 3)
